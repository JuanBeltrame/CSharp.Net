...
namespace LibreriaDeCondicionales
{
    ...
    public class Ejercicio10_7
    {
        ...
        {
            Console.WriteLine("Se ingreso al ejercicio {0}", nameof(Ejercicio10_7));
            Console.WriteLine();
        }
        private static void CargaYCalculo()
        {
            ...
            descuento = acumulador * (float)0.90;
            aumento = acumulador * (float)1.10;
            ...
            Console.WriteLine();
            Console.WriteLine(". El 10% menos, del acumulador es: " + descuento);
            Console.WriteLine();
            Console.WriteLine(". El 110% mas, del valor del acumulador es: " + aumento);
            Console.WriteLine();
